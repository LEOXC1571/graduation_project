...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.18\linewidth]{figure/zjgsu} % 这个位置可能需要调整
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        \item 有一些 \LaTeX{} 自带的
        \item 有一些Tsinghua的
        \item 推荐\LaTeX studio \url{https://www.latexstudio.net/}
        \item 为我的论文、笔记、简历提供了好用的模版
    \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        \item 2021.12-2022.01：完成文献调研/实验平台
        \item 2022.01-2022.02：进行综述写作/完成多个基准模型实验
        \item 2022.02-2022.04：进行算法创新点验证，迭代算法
        \item 2022.04-2022.09：搭建标签推荐原型系统
        \item 2022.10-2022.11：论文撰写
    \end{itemize}
\end{frame}
