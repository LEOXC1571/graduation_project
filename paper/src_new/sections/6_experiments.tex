...
为了公平客观的评价GFMDiff的性能，本文选取的基线模型都是具备完整可复现开源代码的模型，并在采用一致基本参数设置的条件下，本文直接引用基线模型声称的实验结果。
